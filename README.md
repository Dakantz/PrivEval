...
```bash
uv sync
uv pip install --extra-index-url=https://pypi.nvidia.com  "cudf-cu12==25.6.*" "dask-cudf-cu12==25.6.*" "cuml-cu12==25.6.*"  "cugraph-cu12==25.6.*" "nx-cugraph-cu12==25.6.*" "cuxfilter-cu12==25.6.*"  "cucim-cu12==25.6.*" "pylibraft-cu12==25.6.*" "raft-dask-cu12==25.6.*"  "cuvs-cu12==25.6.*" "nx-cugraph-cu12==25.6.*" --prerelease=allow --index-strategy unsafe-best-match
```
